...
sprite_index = spr_rock; // Replace with your actual sprite sheet name

// Define the number of frames in the sprite sheet
var frame_count = 3; // Adjust this number if your sprite sheet has a different number of frames
