...
for(var _i=0; _i<array_length(obj_player.hand); _i++){
	...
	if(
		...
		switch(obj_player.hand[_i]){
			case ELEMENTS.CL:
				draw_element(200,50,17,35.453,"Chlorine","Cl");
				break;
			case ELEMENTS.FE:
				draw_element(200,50,26,55.845,"Iron","Fe");
				break;
			case ELEMENTS.MG:
				draw_element(200,50,12,24.305,"Magnesium","Mg");
				break;
			case ELEMENTS.NI:
				draw_element(200,50,28,58.693,"Nickel","Ni");
				break;
			case ELEMENTS.S:
				draw_element(200,50,16,32.065,"Sulfur","S");
				break;
			case ELEMENTS.ZN:
				draw_element(200,50,30,65.380,"Zinc","Zn");
				break;
		}
	}
}